...
class Progressegaz extends StatefulWidget {
  @override
  _ProgressegazState createState() => _ProgressegazState();
}

class _ProgressegazState extends State<Progressegaz> {
  @override
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              ...
              child: Text("Impossible d'acceder a internet"),
            ),
          ],
        ),
      ),
